...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public User loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        Optional<User> user = userRepository.findByEmail(lowercaseLogin);
        return user.orElseThrow(() -> new UsernameNotFoundException("User " + lowercaseLogin + " was not found in the database"));
    }
}
