package com.fsknso.competition.services.security.utils;

import com.fsknso.competition.core.Role;
import com.fsknso.competition.core.User;
import com.fsknso.competition.services.security.AuthoritiesConstants;
...
//        return user != null && user.getRoles().contains(new Role(permission.name()));
//    }
